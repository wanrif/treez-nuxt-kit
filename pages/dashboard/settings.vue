  ...
  <div class="mx-auto max-w-4xl space-y-6 px-4 sm:px-6">
    ...
    <div class="flex items-center justify-between">
      <template v-if="isMounted">
        <h1 class="text-2xl font-semibold text-treez-900 dark:text-white">{{ t('settings') }}</h1>
      </template>
      <template v-else>
        <div class="h-6 w-32 animate-pulse rounded bg-treez-200 dark:bg-treez-900" />
      </template>
    </div>
    ...
    <template v-if="isMounted">
      <div class="grid gap-6">
        <!-- Account Settings -->
        <div class="rounded-xl bg-white p-6 shadow-sm dark:bg-treez-950">
          <h2 class="mb-6 text-lg font-semibold text-treez-900 dark:text-white">{{ t('account_settings') }}</h2>
          <div class="block">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div class="col-span-2">
                <label class="mb-1 block text-sm font-medium text-treez-700 dark:text-treez-300">
                ...
                <UInput
                  ...
                  class="w-full rounded-lg bg-white text-treez-900 disabled:opacity-50 dark:bg-treez-950 dark:text-white"
                  disabled
                />
              </div>
              <div class="block">
                ...
                <USelect
                  ...
                  :ui="{
                    ...
                    content: 'ring ring-gray-100 dark:ring-treez-900',
                  }"
                  class="w-full rounded-lg bg-white text-treez-900 data-[state=open]:ring-2 data-[state=open]:ring-blue-600 dark:bg-treez-950 dark:text-white dark:data-[state=open]:ring-blue-600"
                />
              </div>
              <div class="block">
                <label class="mb-1 block text-sm font-medium text-treez-700 dark:text-treez-300">
        ...
        <div class="rounded-xl bg-white p-6 shadow-sm dark:bg-treez-950">
          <h2 class="mb-6 text-lg font-semibold text-treez-900 dark:text-white">{{ t('change_password') }}</h2>
        ...
        <!-- Privacy -->
        <div class="rounded-xl bg-white p-6 shadow-sm dark:bg-treez-950">
          <h2 class="mb-6 text-lg font-semibold text-treez-900 dark:text-white">{{ t('privacy_security') }}</h2>
          <div class="space-y-6">
            <div>
              <label class="mb-1 block text-sm font-medium text-treez-700 dark:text-treez-300">
              ...
              <USelect
                ...
                :ui="{
                  trailingIcon: 'group-data-[state=open]:rotate-180 transition-transform duration-200',
                  content: 'ring ring-gray-100 dark:ring-treez-900',
                  item: 'data-highlighted:not-data-disabled:text-[var(--ui-text)] data-highlighted:not-data-disabled:before:bg-treez-50/50 dark:data-highlighted:not-data-disabled:before:bg-treez-950/50',
                }"
                class="w-full rounded-lg bg-white px-4 py-2 text-treez-900 data-[state=open]:ring-2 data-[state=open]:ring-blue-600 dark:bg-treez-950 dark:text-white dark:data-[state=open]:ring-blue-600"
              />
            </div>
            ...
            <div class="flex flex-col gap-4">
              <div class="flex items-center justify-between">
                <div class="flex flex-col">
                  <h3 class="text-sm font-medium text-treez-900 dark:text-white">
                    {{ t('two_factor_auth') }}
                  </h3>
                  <p class="text-sm text-treez-500 dark:text-treez-400">
        ...
        <!-- Appearance -->
        <div class="rounded-xl bg-white p-6 shadow-sm dark:bg-treez-950">
          <h2 class="mb-6 text-lg font-semibold text-treez-900 dark:text-white">{{ t('appearance') }}</h2>
          <div class="space-y-6">
            <div>
              <label class="mb-3 block text-sm font-medium text-treez-700 dark:text-treez-300">
                {{ t('theme') }}
              </label>
                ...
                <button
                  ...
                  :class="[
                    settings.appearance.theme === theme.value
                      ...
                      : 'border-treez-300 hover:border-blue-600/50 dark:border-treez-600',
                  ]"
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <div>
                  <h3 class="text-sm font-medium text-treez-900 dark:text-white">Compact Mode</h3>
                  <p class="text-sm text-treez-500 dark:text-treez-400">Reduce spacing and padding</p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  <h3 class="text-sm font-medium text-treez-900 dark:text-white">Enable Animations</h3>
                  <p class="text-sm text-treez-500 dark:text-treez-400">Show animations and transitions</p>
                </div>
        ...
        <!-- Notifications -->
        <div class="rounded-xl bg-white p-6 shadow-sm dark:bg-treez-950">
          <h2 class="mb-6 text-lg font-semibold text-treez-900 dark:text-white">{{ t('notifications') }}</h2>
          <div class="space-y-4">
            <div v-for="(value, key) in settings.notifications" :key="key" class="flex items-center justify-between">
              <div>
                <h3 class="text-sm font-medium text-treez-900 capitalize dark:text-white">
    ...
    <template v-else>
      <div class="grid gap-6">
        <div v-for="i in 4" :key="i" class="rounded-xl bg-white p-6 shadow-sm dark:bg-treez-950">
          <div class="mb-6 h-6 w-32 animate-pulse rounded bg-treez-200 dark:bg-treez-900" />
          <div class="space-y-4">
            <div v-for="j in 3" :key="j" class="flex items-center justify-between">
              <div class="space-y-2">
                <div class="h-4 w-24 animate-pulse rounded bg-treez-200 dark:bg-treez-900" />
                <div class="h-3 w-48 animate-pulse rounded bg-treez-200 dark:bg-treez-900" />
              </div>
              <div class="h-6 w-11 animate-pulse rounded-full bg-treez-200 dark:bg-treez-900" />
            </div>
          </div>
        </div>
      </div>
