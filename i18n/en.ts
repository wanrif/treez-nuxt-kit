export default {
  ...
  error_help: 'Please try again or return to the homepage',
  ...
  updates_notifications: 'Updates Notifications',

  // Appearance
  appearance: 'Appearance',
  theme: 'Theme',
  compact_mode: 'Compact Mode',
  reduce_spacing: 'Reduce spacing and padding',
  enable_animations: 'Enable Animations',
  show_animations: 'Show animations and transitions',
  ...
  receive_notifications: 'Receive {type} notifications',
  ...
  hero_subtitle:
    'Build faster, scale smarter. Your ultimate Nuxt.js boilerplate for creating modern web applications with confidence.',
  hero_get_started: 'Get Started',
  hero_learn_more: 'Learn More',

  // Features
  feature_fast_title: 'Lightning Fast',
  feature_fast_desc: 'Built for performance and optimal user experience.',
  feature_modular_title: 'Modular Design',
  feature_modular_desc: 'Flexible components that work seamlessly together.',
  feature_ready_title: 'Production Ready',
  feature_ready_desc: 'Deploy with confidence using best practices.',
  ...
  // Register page
  register: 'Register',
  register_welcome: 'Create a new account to get started',
  name_label: 'Name',
  ...
  user_manage_sessions_title: 'Manage Sessions for {name}',
  user_revoke_all_sessions: 'Revoke All Sessions',
  user_revoke_sessions_description: 'This will revoke all active or specific sessions for this user.',
  user_list_sessions: 'List Sessions',
  user_manage_sessions_button_label: 'Manage Sessions',
  user_active_sessions_count: '{count} active sessions',
  error_fetching_sessions_title: 'Error Fetching Sessions',
  user_no_active_sessions: 'No active sessions found.',
  session_token_label: 'Session Token',
  session_created_at_label: 'Created At',
  session_expires_at_label: 'Expires At',
  revoke_button_label: 'Revoke',
  error_revoke_session_title: 'Error Revoking Session',
  success_revoke_session_title: 'Session Revoked Successfully',
  error_revoke_all_sessions_title: 'Error Revoking All Sessions',
  success_revoke_all_sessions_title: 'All Sessions Revoked Successfully',
